...
export const SITE = {
  ...
  description:
    'ร้านรับซื้อโน๊ตบุ๊ค รับซื้อโน๊ตบุ๊คมือสองหลายยี่ห้อ รับซื้อ Notebook, MacBook, Gaming Notebook และเครื่องเสียบางอาการ ส่งรูปเช็คราคาโน๊ตบุ๊คฟรีผ่าน LINE @webuy หรือโทร 0642579353',
  ...
  /**
   * TODO_OWNER: ยืนยันเวลาเปิด-ปิดจาก Google Business Profile แล้วค่อย
   * 1) ใส่ข้อความเวลาทำการใน Footer/ติดต่อเรา และ
   * 2) เพิ่ม openingHoursSpecification ใน LocalBusiness schema
   * ห้ามใช้เวลางานพนักงานแทนเวลาร้าน
   */
} as const;
