...
WHO_B = [
    ...
    'ผู้ที่อยากเช็คราคาโน๊ตบุ๊คก่อนตัดสินใจขายจริงก็ใช้ช่องทางเดียวกันได้ แค่แจ้งว่าต้องการประเมินเบื้องต้นเพื่อเปรียบเทียบกับราคาประเมินอ้างอิงหรือราคาที่เพื่อนเคยขาย โดยไม่มีข้อผูกมัดในการส่งเครื่องจนกว่าจะตกลงเงื่อนไขชัดเจน'
]
...
![นัดรับตรวจเช็กเครื่องด่วนและโอนเงินอย่างรวดเร็ว {title}](/images/trust/rubsue-notebook-trust-cash-payment.webp)
*มั่นใจได้ ทั้งหมด กับการตกลงนัดรับในที่สาธารณะ ปลอดภัย ตรวจเช็กเครื่องรวดเร็ว และโอนเงินอย่างรวดเร็วเมื่อตกลงสภาพ*
...
def main():
    ...
    for f, loc in locations.items():
        ...
        if size < 5000:
            ...
            trust_str = f"![นัดรับตรวจเช็กเครื่องด่วนและโอนเงินอย่างรวดเร็ว {title}](/images/trust/rubsue-notebook-trust-cash-payment.webp)"
